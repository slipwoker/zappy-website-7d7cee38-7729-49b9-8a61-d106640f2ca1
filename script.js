  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (!isNaN(minLength) && value.length < minLength) {
        setError(field, field.dataset.errorMinlength || 'Input is too short.');
        return false;
      }

      if (!isNaN(maxLength) && value.length > maxLength) {
        setError(field, field.dataset.errorMaxlength || 'Input is too long.');
        return false;
      }
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '7d7cee38-7729-49b9-8a61-d106640f2ca1',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '7d7cee38-7729-49b9-8a61-d106640f2ca1';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '7d7cee38-7729-49b9-8a61-d106640f2ca1';
